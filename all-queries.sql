...
# if (activity_type_id === 6 || (activity_type_id >= 8 && activity_type_id <= 15)) {
...
# if(activity_type_id === 4 && sector_or_program === 'স্ক্রুটিনী'){
    let query = WITH acFactor AS
...
let query = with daysCheck as (select distinct quantity from Evaluates_Course_Activity eca
